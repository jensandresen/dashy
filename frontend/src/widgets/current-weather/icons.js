...
export function CloudyWithSun({ width }) {
  return (
    <Container width={width}>
      <svg
        version="1.1"
...
export function CloudyWithLightning({ width }) {
  return (
    <Container width={width}>
      <svg
        version="1.1"
        ...
        style={{ enableBackground: "new 0 0 60.7 48.7" }}
        xmlSpace="preserve"
      >
        <g id="Cloud_4">
          <g id="White_cloud_4">
...
export function CloudyWithMoon({ width }) {
  return (
    <Container width={width}>
      <svg
        version="1.1"
        ...
        style={{ enableBackground: "new 0 0 60.7 44.4" }}
        xmlSpace="preserve"
      >
        <g id="Cloud_5">
          <g id="White_cloud_5">
...
export function CloudyWithRainAndLightning({ width }) {
  return (
    <Container width={width}>
      <svg
        version="1.1"
        ...
        y="0px"
        viewBox="0 0 60.7 80"
        style={{ enableBbackground: "new 0 0 60.7 55" }}
        xmlSpace="preserve"
      >
        <g id="Cloud_6">
          <g id="White_cloud_6">
  ...
  return (
    <Container width={width}>
      <svg
        ...
        style={{ enableBbackground: "new 0 0 44.9 44.9" }}
        xmlSpace="preserve"
      >
        <g id="Sun">
          <circle
...
export function ClearNight({ width }) {
  return (
    <Container width={width}>
      <svg
        version="1.1"
        ...
        style={{ enableBbackground: "new 0 0 30.8 42.5" }}
        xmlSpace="preserve"
      >
        <path
          id="Moon"
...
export function SunnyWithWind({ width }) {
  return (
    <Container width={width}>
      <svg
        version="1.1"
        ...
        style={{ enableBbackground: "new 0 0 45.1 47.6" }}
        xmlSpace="preserve"
      >
        <g id="Wind_Sun">
          <g id="Sun_1_">
  ...
  return (
    <Container width={width}>
      <svg
        ...
        style={{ enableBbackground: "new 0 0 55.1 52.5" }}
        xmlSpace="preserve"
      >
        <g id="Cloud_7">
          <g id="White_cloud_7">
